...
@onready var attack_collision: CollisionShape2D = Player.get_node(
	"attack_position2D_vertical/attack_area/collision_attack"
)
@onready var attack_sprite: Sprite2D = Player.get_node(
	"attack_position2D_vertical/attack_area/sprite_attack"
)
