...
func _ready():
	get_parent().get_parent().get_node("Marker2D").get_node("sprite_attack").visible = false
	disabled = true
...
func _input(delta):
	if Input.is_key_pressed(KEY_A) and not get_parent().get_parent().get_node("Marker2D").get_node("sprite_attack").visible:
			get_parent().get_parent().get_node("Marker2D").get_node("sprite_attack").visible = true
			disabled = false
			attack_timer.start()
...
func _process(delta):
	if get_parent().get_parent().get_node("Marker2D").get_node("sprite_attack").visible and attack_timer.is_stopped():
			get_parent().get_parent().get_node("Marker2D").get_node("sprite_attack").visible = false
			disabled = true
