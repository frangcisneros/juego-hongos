...
var attack_list = [
	"second_phase_attack1_state_first_boss",
	"second_phase_attack2_state_first_boss",
	"second_phase_attack3_state_first_boss",
	"second_phase_attack4_state_first_boss"
]
...
func Exit():
	...
	Enemigo.position2D.scale.x = (
		abs(player.global_position.x - Enemigo.global_position.x)
		/ (player.global_position.x - Enemigo.global_position.x)
	)
	StateActive = false
