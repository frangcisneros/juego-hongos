...
@onready var collision_query_cs: CollisionShape2D = Enemigo.get_node(
	"position2D/collision_query/CollisionShape2D"
)
@onready var collision_query2_cs: CollisionShape2D = Enemigo.get_node(
	"position2D/collision_query2/CollisionShape2D"
)
